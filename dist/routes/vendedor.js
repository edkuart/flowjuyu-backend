...
// ===========================
// Handler tipado como RequestHandler (Promise<void>)
// ===========================
const upsertPerfil = async (req, res) => {
    try {
        ...
        // Borra archivo local previo solo si era local
       ...
       ON CONFLICT (id) DO UPDATE SET
        ...
        return; // explícito para dejar claro que terminamos
    }
    catch (error) {
...
// ===========================
// POST /perfil  (montado bajo /api/seller → /api/seller/perfil)
// ===========================
